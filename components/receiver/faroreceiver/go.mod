module github.com/grafana/opentelemetry-collector-components/receiver/faroreceiver

go 1.19

require (
	github.com/go-logfmt/logfmt v0.6.0
	github.com/grafana/opentelemetry-collector-components v0.0.3
...
replace github.com/grafana/opentelemetry-collector-components => ../../..
