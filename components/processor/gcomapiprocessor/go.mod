...
require go.opentelemetry.io/collector/config/configtelemetry v0.87.0 // indirect; v0.87.0
...
require (
	...
	go.opentelemetry.io/collector/featuregate v1.0.0-rcv0016 // indirect; v0.87.0
